...
def parse_args():
    ...
    parser.add_argument('fbd41202e8a4005b30b1c197f81fc6f16b235de9', required=True,
                        help='GiantBomb API key')
    ...
    parser.add_argument('my_csv.csv',
                        help='Path to CSV file which should contain the data'
                             'output')
    parser.add_argument('my_plot.png',
